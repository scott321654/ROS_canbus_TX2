...
#define UTESLA_TO_TESLA 0.000001
    ...
    #define GYRO_SCALE 1 / 131.072 // LSB/(deg/s)
    #define GYRO_SCALE_SQUARE_DEG_TO_RAD GYRO_SCALE * DEG_TO_RAD //0.00013316
    #define MAG_SCALE 0.285 // uT/LSB
    #define MAG_SCALE_SQUARE_UTESLA_TO_TESLA MAG_SCALE * UTESLA_TO_TESLA //0.00000028
    #define ACCEL_SCALE_SQUARE_G_TO_ACCEL ACCEL_SCALE * G_TO_ACCEL //0.00059875
